...
_uiElementsJs.UI_ELEMENTS.BUTTON.addEventListener('click', sendDate);
function sendDate() {
    event.preventDefault();
    const inputValue = _uiElementsJs.UI_ELEMENTS.INPUT.value;
    const date = _dateFns.formatDistanceToNowStrict(new Date(inputValue), {
        unit: "day"
    }).slice(-8, -4);
    const result = "\u0420\u0430\u0437\u043D\u0438\u0446\u0430 \u043C\u0435\u0436\u0434\u0443 \u0434\u0430\u0442\u0430\u043C\u0438 " + date + 'день/дней';
    _uiElementsJs.UI_ELEMENTS.SPAN.textContent = result;
    console.log(result);
}

},{"./ui_elements.js":"4QdtK","date-fns":"9yHCA"}],"4QdtK":[function(require,module,exports) {
...
const UI_ELEMENTS = {
    ...
    SPAN: document.querySelector('.date-show'),
...
},{"../_lib/getTimezoneOffsetInMilliseconds/index.js":"bc74C","../compareAsc/index.js":"h01l4","../toDate/index.js":"fsust","../_lib/cloneObject/index.js":"PgZBT","../locale/en-US/index.js":"8XKCq","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bc74C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9FmDM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
